"""
Django settings for zoho_proxy project.
...
SECRET_KEY = 'django-insecure-cf7@6*!unskvk-jd0cnzagiyq&lkagzlp7l=vpmkiojp8=4^r)'
...
WSGI_APPLICATION = 'zoho_proxy.wsgi.application'
